  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Line type="monotone" name='Чистая прибыль' dataKey="uv" stroke="#112347" strokeWidth={3} />
          <Line type="monotone" name='Прибыль до вычета налогов' dataKey="pv" stroke="#0069D0" strokeWidth={3} />
        </LineChart>
      </ResponsiveContainer>
  );
};
