        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_taxes_tax_types_type_id",
                        column: x => x.type_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_absences_absence_types_type_id",
                        column: x => x.type_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_work_orders_order_priorities_priority_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_bills_bill_statuses_status_id",
                        column: x => x.status_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_acceptance_imgs_acceptances_acceptance_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    position_id = table.Column<long>(type: "bigint", nullable: false),
                    proposal_id = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_payment_journal_payment_methods_method_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_acceptance_imgs_acceptance_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_payment_journal_method_id",
                table: "payment_journal",
                column: "method_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_work_orders_priority_id",
                table: "work_orders",
                column: "priority_id");
