...
namespace CRMSystem.DataAccess.Migrations
{
    ...
    [Migration("20260224114605_AddOrganizationAndOrderFields")]
    partial class AddOrganizationAndOrderFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.AbsenceEntity", b =>
                {
                    ...
                    b.HasIndex("TypeId")
                        .HasDatabaseName("ix_absences_type_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.AcceptanceImgEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_acceptance_imgs");

                    b.HasIndex("AcceptanceId")
                        .HasDatabaseName("ix_acceptance_imgs_acceptance_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.OrderEntity", b =>
                {
                    ...
                    b.Property<string>("OrderAgreementPdfFileName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("order_agreement_pdf_file_name");

                    b.Property<string>("OrderPdfFileName")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("order_pdf_file_name");
                    ...
                    b.HasIndex("PriorityId")
                        .HasDatabaseName("ix_work_orders_priority_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.PaymentNoteEntity", b =>
                {
                    ...
                    b.HasIndex("MethodId")
                        .HasDatabaseName("ix_payment_journal_method_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.TaxEntity", b =>
                {
                    ...
                    b.HasIndex("TypeId")
                        .HasDatabaseName("ix_taxes_type_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.AbsenceEntity", b =>
                {
                    b.HasOne("CRMSystem.DataAccess.Entites.AbsenceTypeEntity", "AbsenceType")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_absences_absence_types_type_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.AcceptanceImgEntity", b =>
                {
                    b.HasOne("CRMSystem.DataAccess.Entites.AcceptanceEntity", "Acceptance")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_acceptance_imgs_acceptances_acceptance_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.BillEntity", b =>
                {
                    ...
                    b.HasOne("CRMSystem.DataAccess.Entites.BillStatusEntity", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bills_bill_statuses_status_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.OrderEntity", b =>
                {
                    ...
                    b.HasOne("CRMSystem.DataAccess.Entites.OrderPriorityEntity", "OrderPriority")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_work_orders_order_priorities_priority_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.PaymentNoteEntity", b =>
                {
                    ...
                    b.HasOne("CRMSystem.DataAccess.Entites.PaymentMethodEntity", "Method")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_payment_journal_payment_methods_method_id");
            ...
            modelBuilder.Entity("CRMSystem.DataAccess.Entites.TaxEntity", b =>
                {
                    b.HasOne("CRMSystem.DataAccess.Entites.TaxTypeEntity", "TaxType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_taxes_tax_types_type_id");
