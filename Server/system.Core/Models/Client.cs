...
public class Client
{
    ...
    public static (Client? client, List<string>? errors) Create(
        long id, long userId, string name, string surname, string phoneNumber, string email)
    {
        ...
        var surnameError = DomainValidator
            .ValidateString(surname, ValidationConstants.MAX_SURNAME_LENGTH, "surname");
        ...
        var phoneError = DomainValidator
            .ValidateString(phoneNumber, ValidationConstants.MAX_PHONE_LENGTH, "phoneNumber");
        ...
        var emailError = DomainValidator
            .ValidateString(email, ValidationConstants.MAX_EMAIL_LENGTH, "email");
