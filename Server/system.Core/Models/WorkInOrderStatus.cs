...
public class WorkInOrderStatus
{
    ...
    public static (WorkInOrderStatus? workInOrderStatus, List<string>? errors) Create(int id, string name)
    {
        ...
        var workInOrderStatus = new WorkInOrderStatus(id, name);

        return (workInOrderStatus, new List<string>());
    }
}
